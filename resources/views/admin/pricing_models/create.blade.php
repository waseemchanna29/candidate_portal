@extends('layouts.app')
@section('title', 'Add Pricing Model')
@section('page-title', 'Add Pricing Model')

@section('content')
<div class="page-header">
    <div>
        <div class="page-header-title">Add Pricing Model</div>
        <div class="page-header-sub">Create a new pricing plan to assign to courses</div>
    </div>
...
<div style="max-width:680px;">
    <div class="card">
        <div class="card-header">
            <div class="card-header-title"><i class="fas fa-tags"></i> Pricing Model Details</div>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.pricing-models.store') }}" method="POST" novalidate>
                @csrf
                ...
                <div class="mb-form">
                    ...
                    <input type="text" name="name"
                           ...
                           value="{{ old('name') }}"
                           placeholder="e.g. Standard Fee, Full Payment">
                ...
                <div class="mb-form">
                    ...
                    <textarea name="description" rows="3"
                              ...
                              placeholder="Any notes about this pricing plan...">{{ old('description') }}</textarea>
