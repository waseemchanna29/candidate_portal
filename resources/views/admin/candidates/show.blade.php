                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.candidates.approve', $candidate) }}" method="POST">
                            ...
                            <div class="mb-form">
                                ...
                                <textarea name="admin_notes" class="form-control" rows="3" placeholder="Any note for the candidate..."></textarea>
                            </div>
                            <button type="submit" class="btn-block btn btn-success"
                                onclick="return confirm('Approve this application and assign a unique code?')">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.candidates.reject', $candidate) }}" method="POST">
                            ...
                            <div class="mb-form">
                                ...
                                <textarea name="admin_notes" class="form-control {{ $errors->has('admin_notes') ? 'is-invalid' : '' }}" rows="3"
                ...
                <span class="profile-meta-value">
                    @if ($candidate->course)
                        ...
                        <span style="color:var(--text-muted); font-size:0.85rem; display:block;">
                            {{ $candidate->course->duration_label }} &bull; {{ $candidate->course->formatted_price }}
                        </span>
                    @else
        ...
        <div class="card-body" style="padding:0;">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" style="text-align:center; color:var(--text-muted);">No experience listed.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
